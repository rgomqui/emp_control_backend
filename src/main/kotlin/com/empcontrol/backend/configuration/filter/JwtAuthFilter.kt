package com.empcontrol.backend.configuration.filter
...
class JwtAuthFilter(
    ...
    override fun doFilterInternal(
        ...
        val user = employeeRepository.findByUsername(username).orElseThrow{ ObjectNotFoundException("Employee $username not found.") }
